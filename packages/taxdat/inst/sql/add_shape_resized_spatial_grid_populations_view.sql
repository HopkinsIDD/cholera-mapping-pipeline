...
INNER JOIN public.raster_covariate_collections ON all_covariates.raster_covariate_collection_id = raster_covariate_collections.id
WHERE
  raster_covariate_collections.name = 'population');
