...
case_definition_to_column_name = function(type,database=FALSE,sql=FALSE){
  .Deprecated(msg = "case_definition_to_column_name is deprecated because it is no longer used by the cholera mapping pipeline.", package = "taxdat", old = "case_definition_to_column_name")
  if((!database) & (!sql)){
