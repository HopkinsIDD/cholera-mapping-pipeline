...
#'
#' @examples
check_drop_low_pop_lps <- function(x,
                                   default_value = FALSE) {
...
#' @title check_drop_low_pop_lps_thresh
#' @description Checks whether population thresh for grid cell connection to lp is valid
#' @param drop_low_pop_lps_thresh
#' @return
#' @export
check_drop_low_pop_lps_thresh <- function(drop_low_pop_lps_thresh) {
  ...
  return(drop_low_pop_lps_thresh)
}