...
process_genquant <- function(config, country_cache, cholera_directory, ...) {
  ...
  cases <- country_cache[["genquant"]]$summary(
  ...
  rates <- country_cache[["genquant"]]$summary(
    variables = "location_rates_output",
    c(
      posterior::default_summary_measures(),
      posterior::default_convergence_measures()
    ),
  ...
  pop <- country_cache[["genquant"]]$summary(
    variables = "pop_loctimes_output",
    c(
      posterior::default_summary_measures(),
      posterior::default_convergence_measures()
    ),
  ...
  output_data <- country_cache[["output_shapefiles"]] %>%
    inner_join(cases %>% dplyr::select(
      cases = mean,
      cases_q5 = q5,
      cases_q95 = q95,
      location_period_id, TL
    )) %>%
    inner_join(rates %>% dplyr::select(
      rate = mean,
      rate_q5 = q5,
      rate_q95 = q95,
      location_period_id, TL
    )) %>%
    inner_join(pop %>% dplyr::select(
      pop = mean,
      location_period_id, TL
    ))
  ...
  tot_cases <- country_cache[["genquant"]]$summary(
    variables = "location_total_cases_output",
    c(
      posterior::default_summary_measures(),
      posterior::default_convergence_measures()
    ),
  ...
  tot_rates <- country_cache[["genquant"]]$summary(
    variables = "location_total_rates_output",
    c(
      posterior::default_summary_measures(),
      posterior::default_convergence_measures()
    ),
  ...
  tot_pop <- country_cache[["genquant"]]$summary(
    variables = "pop_loctimes_output",
    c(
      posterior::default_summary_measures(),
      posterior::default_convergence_measures()
