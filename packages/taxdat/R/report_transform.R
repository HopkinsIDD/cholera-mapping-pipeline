...
#' @name aggregate_long_modeled_grid_case_by_grid_no_cache
#' @title aggregate_modeled_cases_mean_by_chain_no_cache
#' @description get modeled cases mean by polygon (location periods)
#' @param config config file that contains the parameter information
#' @param cache the cached environment
...
#' @export
#' @name aggregate_long_modeled_grid_case_by_grid
aggregate_long_modeled_grid_case_by_grid <- cache_fun_results(
  "long_modeled_grid_case_by_grid",
  aggregate_long_modeled_grid_case_by_grid_no_cache
)
