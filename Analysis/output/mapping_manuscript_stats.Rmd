...
output_endemicity_50 %>% 
  ...
  dplyr::select(
    `10-year risk cat`,`Population(million) (50%)`, `Number of adm2 units (50%)`, `Total number of adm2 units (50%)`,`% of adm2 units (%) (50%)`,`Total number of countries (50%)`,`Population(million) (95%)`, `Number of adm2 units (95%)`, `Total number of adm2 units (95%)`,`% of adm2 units (%) (95%)`,`Total number of countries (95%)`
  ) %>% 
  knitr::kable() %>% 
  kableExtra::kable_styling(bootstrap_options = c("striped")) %>%
    kableExtra::kable_paper(full_width = F)
