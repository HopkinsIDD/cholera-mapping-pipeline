...
OR_text %>% 
  kableExtra::kbl(caption = "Table 29. Odd ratios of cholera occurrence by region:\n") %>% 
  kableExtra::kable_styling(full_width = F) 
```
...
baseline_prob_stats %>% 
  ...
  kableExtra::kbl(caption = "Table 30. Probability of cholera occurrence for sustained low group by region") %>% 
  kableExtra::kable_paper(full_width = F)
```
