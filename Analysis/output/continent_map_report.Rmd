...
params:
  ...
  separate_TZA: c("TZA_mainland", "TZA_zanzibar") #OPTIONAL: "TZA" if running the country was run as a whole or empty is not included 
...
```{r map_plotting_tmp, include=FALSE}
### Plotting -- simply outputs PDF files for now 
