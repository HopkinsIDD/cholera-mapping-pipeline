...
```{r plot_pop_failures, fig.cap = "Failures for population check"}
...
ggplot2::ggplot(rhat_failures, ggplot2::aes(y = cntry)) +
  ggplot2::geom_tile(ggplot2::aes(fill = failure_rhat)) +
  ggplot2::geom_label(ggplot2::aes(label = frac_above)) 
