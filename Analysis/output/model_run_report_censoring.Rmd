...
sf_cases_resized <- taxdat::read_file_of_type(stan_inuput_filename, "stan_input")$sf_cases_resized
...
model.rand <- taxdat::read_file_of_type(filename = file_names["stan_output"],"model.rand")

modeled_cases <- taxdat::get_modeled_cases(model.rand = model.rand,
                                   stan_input_filename = file_names["stan_input"])
...
taxdat::plot_rhat(model.rand = model.rand,
