...
## Figure 5. Association between 2022-203 cholera occurrence and 10-year risk classifications for 2011-2020
...
png("fig12.png",width = 2000,height = 1000, res = 300)
...
knitr::include_graphics( "fig13.png")
```
