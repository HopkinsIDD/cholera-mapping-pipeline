...
params:
  ...
  config: "configs/config_ID_03_HTI_2021_2024.yml"
output: 
...
for (i in seq_along(parts)) {
  cat(
    "# Table 2. Summary of data coverage: ", country_full_name,
    " (Part ", i, ")\n\n", 
    sep = ""
  )
...
::: notes
Table 2. Data coverage summary for `r country_full_name`, 2021-2024. The table summarizes the data coverage by observation collection ID, year, and spatial scale for `r country_full_name`.
:::
...
# Figure 6. Temporal distribution of data coverage by admin level in `r country_full_name`
...
select(admin_level,year,cases_full_total) %>% 
mutate(admin_level = factor(admin_level, levels = 0:3))


fig6<- ggplot(cases_by_admin, aes(x = year, y = cases_full_total, fill = admin_level)) +
...
::: notes
Figure 6.  Temporal distribution of data coverage by admin level for `r country_full_name` in 2021-2024. The barplot shows total cases reported at each administrative level in 2021-2024. The zero-level administrative unit is the country-level.
:::