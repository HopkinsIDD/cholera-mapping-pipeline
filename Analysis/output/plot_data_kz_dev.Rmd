...
params:
  config: "/Analysis/configs/Dec_2021_runs/MOZ_2015_2019/config_MOZ_2015_2019.yml"
...
plot1_height_factor <- 3 * length( unique(raw_data_filtered[c('location_name', 'year'), ]) ) / plot1_ncol_factor
...
plot2_height_factor <- 3 * length( unique(raw_data_filtered[c('location_name', 'year'), ]) ) / plot2_ncol_factor
