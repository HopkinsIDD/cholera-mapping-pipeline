...
params:
  config: "Analysis/configs/production_tests/Dev_nocovar/2015_2019_country/config_AGO_2015_2019.yml"
  cholera_directory: "/home/kaiyuezou/mapping_pipeline/dev_production/cholera-mapping-pipeline"
...
for (years in sum_obs2$year){
  ...
  list2 <- unique(taxonomy_data[taxonomy_data$year == years, ]$location_period_id)
  ...
  list2 <- unique(taxonomy_data[taxonomy_data$year == years, ]$observation_collection_id)
  if(length(setdiff(list2, list1)) == 0){
