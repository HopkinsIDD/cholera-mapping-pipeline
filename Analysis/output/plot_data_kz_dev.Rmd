...
## Overall figure -- all observation collections by location only
...
plot1pre_height_factor <- 3 * length(unique(raw_data_filtered$location_name)) / plot1pre_ncol_factor
...
### This comprehensive figure includes all pre-processed observations that span across multiple years. 
