...
if(across_year_indicator){ plot1_height_factor_2 = 5 * (nrow(raw_across_year_data_filtered) / 2) } 
...
if(across_year_indicator){
  print('Now plotting the observations spanning across multiple years. ')
  if (period_OC_divided_by_timelength){
