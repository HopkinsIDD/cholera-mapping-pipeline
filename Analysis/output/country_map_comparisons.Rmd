...
#   output_dir = "Analysis/output/national_comp/",
#   old_map_rate = "old_products/rate.tif",
#   old_map_case = "old_products/case.tif",
#   shapefiles_dir = "shapefiles/",
#   max_countries = Inf)
...
out_dir <- stringr::str_c(params$cholera_directory, "/Analysis/output/reports/", stringr::str_split(params$config_directory, "/")[[1]]  %>% dplyr::last())
...
plot_df <- dplyr::bind_rows(dplyr::select(country_summ, -pop), country_summ_old) %>%
  ...
  dplyr::mutate(t = factor(t, levels = 1:5, labels = 2015:2019),
