...
params: 
  ...
  config: "/Analysis/configs/config_ZNZ_2015_2019_censoring_nocovar.yml"
...
# get_stan_input_no_cache(config=paste0(params$cholera_directory, params$config),
#                        cache=cache,
...
get_sf_cases_resized(name="sf_cases_resized",
                    cache=cache,
                    config = paste0(params$cholera_directory, params$config),
                    cholera_directory = params$cholera_directory)
...
aggregate_modeled_rates_by_chain_gridtime(name="aggregated_modeled_rates_by_chain_gridtime",
             cache=cache,
             config=paste0(params$cholera_directory, params$config),
             cholera_directory=params$cholera_directory)
