...
#load("C:/IDD/Cholera/cholera-mapping-pipeline/Analysis/output/test1.stan_input.rdata")
sf_cases_resized <- stan_input$observation_data
#load("C:/IDD/Cholera/cholera-mapping-pipeline/Analysis/output/test1.stan_output.rdata")
...
#                                                                              "\niterations: Chain")
# case_raster<-sf::st_as_sf(empty_raster)
# case_raster_case <- case_raster %>% dplyr::select(dplyr::contains("modeled cases"),
#                                                   t,shape) %>% tidyr::gather(dplyr::contains("iterations: Chain"),
#                                                                            key = "chain", value = "value") %>% dplyr::mutate(chain = stringr::str_replace(chain,"modeled cases", ""))
# 
# case_raster_case$t<-factor(case_raster_case$t)
# levels(case_raster_case$t)[1]<-"1"
# levels(case_raster_case$t)[2]<-"2"
