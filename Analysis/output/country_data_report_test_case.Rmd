...
if(all(params$Loc_with_inconsistent_data=="no")){
  ...
  plt <- plt +
    ...
    #ggplot2::scale_shape_manual(values = rep(8,length(params$Loc_with_inconsistent_data)))+
    #ggplot2::scale_shape(name="Locations with \n inconsistent data")+
    #guides(shape = guide_legend(override.aes = list(shape="Locations with \ninconsistent data")))+
    ggplot2::theme_bw() +
    ggplot2::theme(legend.position = "bottom") +
    ggplot2::facet_wrap(~set)
}
