...
# Load config
config <- "Analysis/configs/config_SSD_2017_2017_noweights_censoring_rhoprior_UNICEF_linelist.yml" %>% yaml::read_yaml()
...
```{r cum, fig.width=10, fig.height=12, fig.cap="Cumulative incidence. Daily data is shown as lines and other observation lengths as rectangles."}
