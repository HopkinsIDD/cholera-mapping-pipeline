...
who_annual_cases <- taxdat::pull_output_by_source(who_annual_cases, "%WHO Annual Cholera Reports%",
                                                  database_api_key_file = stringr::str_c(params$cholera_directory, "Analysis/R/database_api_key.R"))
who_annual_cases %>%
  as.data.frame() %>%
...
```{r cases_chain_table, fig.cap = "Sum of grid cases by chain and year"}
try({
