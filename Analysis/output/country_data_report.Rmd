...
pop_raster_data <- raster(paste0(params$config,"/Analysis/2000_1km_Aggregated.tif"))
...
```{r datafidelity1, fig.cap="Observations vs. modeled cases", fig.height=10, fig.width=10}
