...
disjoint_set_sf_cases <- taxdat::get_disjoint_set_sf_cases(preprocessed_data_filename)
```
...
case_raster <- taxdat::get_case_raster(preprocessed_data_filename = preprocessed_data_filename,
                                       covar_data_filename = file_names["covar"],
                                       model_output_filenames = stan_output_filename)
...
data_fidelity <- taxdat::get_data_fidelity(stan_input_filenames = stan_input_filename,
                                          model_output_filenames = stan_output_filename)
...
```{r full country modeled cases, fig.height=5, fig.width=10, fig.cap = "comparison with WHO Output"}
