...
**Table 5. Observed and estimates of WHO annual cholera reports based on the observation-level modeled cases with other sources of annual data added:**
...
## Others 
### Config Parameters
**Table 7. Parameters used within the model:**
```{r echo = FALSE}
...
**Table 8. Population by admin level:**
```{r echo = FALSE}
