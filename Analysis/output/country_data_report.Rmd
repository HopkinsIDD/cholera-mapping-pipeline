...
params:
  ...
  config: "/Analysis/configs/2015_2019_full_base/GHA.yml"
...
if(nrow(sf_grid) == prod(dim(pop_layer))){
  ...
  #setwd(stringr::str_remove(getwd(),"/Analysis/output"))
...
### Modeled cases
**Fig 8. Modeled cases raster by time slices: time1**
  ...
  plt_2020_case_raster <- case_raster %>%
    ...
    ggplot2::geom_sf(
      ...
      ggplot2::aes(fill = value),color=NA,size=0.00001)+
        ggplot2::geom_sf(
      data=plt_2020_case_raster%>%mutate(value=NA),
      fill=NA,color="black")+
