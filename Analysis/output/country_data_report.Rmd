...
**Table 3. Population by admin level using 20*20 km pop raster:**
```{r echo = FALSE}
...
**Table 4. Modeled cases by admin level and time using 20*20 km pop raster:**
```{r echo = FALSE}
...
**Table 5. Modeled incidence rates by admin level and time using 20*20 km pop raster:**
```{r echo = FALSE}
