---
title: "Data and Model Outputs Report SDN"
output: html_document
params:
  cholera_directory: "C:/IDD/Cholera/cmp_report"
  config: "/Analysis/configs/Dec_2021_runs/SDN_2015_2019/config_SDN_2016_2016.yml"
...
# file_names[["stan_input"]]<-"C:/IDD/Cholera/cmp_report/Analysis/data/Ghana_stan_input.rdata"
# file_names["stan_output"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/Ghana_stan_output.rdata"
# file_names["covar"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/Ghana_suspected.dw.covar.rdata"
# file_names["data"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/Ghana_suspected.preprocess.rdata"
# file_names["initial_values"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/Ghana_initial_values.rdata"

# file_names[["stan_input"]]<-"C:/IDD/Cholera/cmp_report/Analysis/data/ZWE_stan_input.rdata"
# file_names["stan_output"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/ZWE_stan_output.rdata"
# file_names["covar"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/ZWE_suspected.dw.covar.rdata"
# file_names["data"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/ZWE_suspected.preprocess.rdata"
# file_names["initial_values"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/ZWE_initial_values.rdata"

# file_names[["stan_input"]]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GHA_stan_input.rdata"
# file_names["stan_output"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GHA_stan_output.rdata"
# file_names["covar"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GHA_suspected.dw.covar.rdata"
# file_names["data"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GHA_suspected.preprocess.rdata"
# file_names["initial_values"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GHA_initial_values.rdata"
# 
# file_names[["stan_input"]]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GIN_stan_input.rdata"
# file_names["stan_output"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GIN_stan_output.rdata"
# file_names["covar"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GIN_suspected.dw.covar.rdata"
# file_names["data"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GIN_suspected.preprocess.rdata"
# file_names["initial_values"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/GIN_initial_values.rdata"
# 
# file_names[["stan_input"]]<-"C:/IDD/Cholera/cmp_report/Analysis/data/CIV_stan_input.rdata"
# file_names["stan_output"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/CIV_stan_output.rdata"
# file_names["covar"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/CIV_suspected.dw.covar.rdata"
# file_names["data"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/CIV_suspected.preprocess.rdata"
# file_names["initial_values"]<-"C:/IDD/Cholera/cmp_report/Analysis/data/CIV_initial_values.rdata"
...
##file_names[["stan_output"]]<-stringr::str_remove(file_names[["stan_output"]],".iv-wN-cwN-csF-teT-teaF-weF-F")
...
#file_names[["stan_output"]]<-"C:/IDD/Cholera/cmp_report/Analysis/data/stan_output.rdata"
...
## GAM Input
**Fig 1. Observations input for the GAM model:**
```{r gam input}
try({
...
# GAM Output
**Fig 2. Observations input for the GAM model:**
```{r gam output}
try({
initial_values_data <- read_file_of_type(file_names["initial_values"], "initial_values_data")
...
**Fig 4. Area adjusted cases by time:**
...
**Fig 5. Cases unique location periods:**
...
### Population
**Fig 6. Population raster by time slices:**
...
#pop_raster_data <- raster("C:/IDD/Cholera/cmp_report/Layers/pop/2000_1km_Aggregated.tif")
pop_raster_data <- raster("/home/qulu/cmp_report/Analysis/2000_1km_Aggregated.tif")
...
if(nrow(sf_grid) == prod(dim(pop_layer))){
  ...
  #import 1*1 KM pop raster and update the covar in the pltdata
  #pop_raster_data <- raster("C:/IDD/Cholera/cmp_report/Layers/pop/2000_1km_Aggregated.tif")
  #pop_raster_data <- raster("/home/qulu/cmp_report/Analysis/2000_1km_Aggregated.tif")
...
### Other covariates
**Fig 7. Distance to water raster:**
...
### Modeled cases
**Fig 8. Modeled cases raster by time slices: time**
...
if(!is.null(case_raster)){
  ...
  #taxdat::plot_modeled_cases(disaggregated_case_sf, render = T)
...
**Fig 9. Modeled incidence rates raster by time slices:**
...
**Fig 10. Actual observations versus modeled cases scatter plot:**
```{r datafidelity1, fig.cap="Observations vs. modeled cases (tfrac adjusted)", fig.height=10, fig.width=10}
...
```{r datafidelity2, fig.cap="Observations/tfrac vs. modeled cases/tfrac ", fig.height=10, fig.width=10}
...
```{r datafidelity3, fig.cap="Observations vs. modeled cases (tfrac adjusted)", fig.height=15, fig.width=10}
...
```{r datafidelity4, fig.cap="Observations vs. modeled cases (tfrac unadjusted)", fig.height=8, fig.width=10}
