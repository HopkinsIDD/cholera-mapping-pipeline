...
# params <- new.env()
# params$cholera_directory <- "/home/kaiyuezou/mapping_pipeline/country_data_report/cholera-mapping-pipeline"
# params$config <- "Analysis/configs/no_covariate_production_2016_2020/2016_2020_country/config_ETH_2016_2020.yml"
...
**Table 3. Modeled cases by admin level and time:**
```{r echo = FALSE}
...
**Table 4. Modeled incidence rates by admin level and time:**
```{r echo = FALSE}
