...
```{r datafidelity2, fig.cap="Observations vs. modeled cases (tfrac adjusted)", fig.height=15, fig.width=10}
...
```{r datafidelity3, fig.cap="Observations vs. modeled cases (tfrac unadjusted)", fig.height=8, fig.width=10}
