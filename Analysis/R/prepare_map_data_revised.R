...
sf::st_geometry(cases[index, ]) <- sf::st_as_sfc(lapply(sf::st_geometry(cases[index,
...
# observations (primary observations are only space-time stratified and these
# are the ones we want to focus on in these maps)
