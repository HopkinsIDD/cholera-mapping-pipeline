...
#========================================================READ ME========================================================#
# This new config writer is updated for the production run on Aug 23 2022
# This new writer only works as supposed to with the updated "auto_config_Aug2022" function in the config_helpers.R 
...
# The created config files will be stored in 'Analysis/configs/no_covariate_production_2016_2020'  
...
config_path <- "Analysis/configs/no_covariate_production_2016_2020" #<-----dependent on what covariate to test
