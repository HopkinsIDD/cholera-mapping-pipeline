...
#### testing.1 ####
all_data[["full observation single covariate"]] <- function() {
  taxdat:::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.2 ####
all_data[["partial observation single covariate mode 1"]] <- function() {
  taxdat:::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.3 ####
all_data[["partial observation single covariate mode 2"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.4 ####
all_data[["partial observation single covariate mode 3"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.5 ####
all_data[["full observation single polygonal covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.6 ####
all_data[["partial observation single polygonal covariate mode 0"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.7 ####
all_data[["partial observation single polygonal covariate mode 1"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.8 ####
all_data[["partial observation single polygonal covariate mode 2"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.9 ####
all_data[["partial observation single polygonal covariate mode 3"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.10 ####
all_data[["partial observation single polygonal covariate mode 4"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.11 ####
all_data[["full observation single matern smoothed covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.12 ####
all_data[["full observation single matern smoothed covariate finer observation scale"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.13 ####
all_data[["single matern smooth spacetime covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.14 ####
all_data[["grid sampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.15 ####
all_data[["matern smoothed population with simple covariate."]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.16 ####
all_data[["oversampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.17 ####
all_data[["full observation single matern smoothed covariate finer observation scale with small population"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.18 ####
all_data[["10 % sampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.19 ####
all_data[["30 % sampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.20 ####
all_data[["50 % sampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.21 ####
all_data[["70 % sampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.22 ####
all_data[["80 % sampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.23 ####
all_data[["90 % sampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.24 ####
all_data[["95 % sampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.25 ####
all_data[["99 % sampled observation single covariate"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.26 ####
all_data[["try1 causing orig model to escape prior"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.27 ####
all_data[["try2 causing orig model to escape prior"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.28 ####
all_data[["try3 causing orig model to escape prior"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.29 ####
all_data[["try4 causing orig model to escape prior"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.30 ####
all_data[["try5 causing orig model to escape prior"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ## Raster parameters:,
    nrows = 20,
...
#### testing.31 ####
all_data[["profiling baseline"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.32 ####
all_data[["profiling gridsize 4x"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.33 ####
all_data[["profiling observations 4x"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
#### testing.34 ####
all_data[["profiling both 4x"]] <- function() {
  taxdat::create_standardized_test_data(
    ## Extent parameters:,
    ### NONE,
    ## Raster parameters:,
...
non_na_gridcells <- which(apply(covar_cube, c(1, 2), function(x) {
  (x[[1]] > 1) & !any(is.na(x))
}))
