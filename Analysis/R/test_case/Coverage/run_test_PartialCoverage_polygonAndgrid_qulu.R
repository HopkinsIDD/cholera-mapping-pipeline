...
test_observations <- observe_polygons(test_polygons = dplyr::mutate(all_dfs$shapes_df, 
    ...
    underlying_distribution = test_underlying_distribution, noise = FALSE, polygon_proportion_observed = 0.4, 
    grid_proportion_observed = 0.4, min_time_left = query_time_left, max_time_right = query_time_right)  #Partial data coverage
# 
...
# Note 2021-08-01 grid report proportion is 0.4 and polygon report proportion is
# also 0.4.
