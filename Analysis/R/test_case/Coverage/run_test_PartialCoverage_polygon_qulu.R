...
test_observations <- observe_polygons(test_polygons = dplyr::mutate(all_dfs$shapes_df, 
    ...
    grid_proportion_observed = 1, min_time_left = query_time_left, max_time_right = query_time_right)  #Partial data coverage
# 
...
# Note 2021-08-01 grid report proportion is 1 and polygon report proportion is
# also 0.4.
