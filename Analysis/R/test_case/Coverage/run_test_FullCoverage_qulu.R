...
#write.csv(data.frame(all_true=class(all_dfs$shapes_df$geom)),'/home/app/cmp/shapes_df.csv')
#writeLines(as.character(all_dfs$shapes_df),"/home/app/cmp/shaps_df.txt")
