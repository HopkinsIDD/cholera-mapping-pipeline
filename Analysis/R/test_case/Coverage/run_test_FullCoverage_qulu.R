...
config_filename <- "/home/app/cmp/Analysis/R/test_config_FullCoverage.yml"
...
config <- list(general = list(location_name = all_dfs$location_df$qualified_name[[1]], 
                              ...
                              width_in_km = 1, height_in_km = 1, time_scale = "12 months"), stan = list(directory = rprojroot::find_root_file(criterion = ".choldir", 
