...
## report
saveRDS(test_covariates_observation_final, "/home/app/cmp/Analysis/output/test_case_1_data_simulation_covariates.rdata")
...
all_dfs$observations_df[which(all_dfs$observations_df$qualified_name == "1"), ]$suspected_cases = sum(all_dfs$observations_df[grep("1::",
    all_dfs$observations_df$qualified_name), ]$suspected_cases)
...
config_filename <- "/home/app/cmp/Analysis/R/config_test_case_1.yml"
...
config <- list(general = list(location_name = all_dfs$location_df$qualified_name[[1]],
    ...
    "Analysis", "output", "test1.stan_input.rdata"), stan_output = rprojroot::find_root_file(criterion = ".choldir",
    "Analysis", "output", "test1.stan_output.rdata")), test_metadata = list(name = "test_1",
    ...
    Loc_with_inconsistent_data = "-", Cov_data_simulation_filename = "/home/app/cmp/Analysis/output/test_case_1_data_simulation_covariates.rdata"))
