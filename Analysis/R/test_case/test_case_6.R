...
config <- list(general = list(
  ...
  criterion = ".choldir",
  "Analysis", "output", "test6.stan_input.rdata"
), stan_output = rprojroot::find_root_file(
  criterion = ".choldir",
  "Analysis", "output", "test6.stan_output.rds"
)), test_metadata = list(
  name = "test_6",
  ...
  Loc_with_inconsistent_data = "-", Cov_data_simulation_filename = "/home/app/cmp/Analysis/output/test_case_6_data_simulation_covariates.rdata",test_true_grid_case_filename="/home/app/cmp/Analysis/output/test_case_6_true_grid_cases.rdata"
...
rmarkdown::render(
  ...
  output_file = "test_case_6_country_data_report"
)