...
saveRDS(test_covariates_observation_final,"/home/app/cmp/Analysis/output/test_case_6_data_simulation_covariates.rdata")
...
saveRDS(test_true_grid_cases,"/home/app/cmp/Analysis/output/test_case_6_true_grid_cases.rdata")
...
config_filename <- "/home/app/cmp/Analysis/R/config_test_case_6.yml"
...
config <- list(general = list(location_name = all_dfs$location_df$qualified_name[[1]], 
               ...
               file_names = list(stan_output = rprojroot::find_root_file(criterion = ".choldir","Analysis", "output", "test6.stan_output.rdata"), 
                                 stan_input = rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output", "test6.stan_input.rdata")),
               nrows=10,
               ncols=10,
               data_type="Grid data",
               oc_type="-",
               ...
               Cov_data_simulation_filename="/home/app/cmp/Analysis/output/test_case_6_data_simulation_covariates.rdata",
               test_true_grid_case_filename="/home/app/cmp/Analysis/output/test_case_6_true_grid_cases.rdata"
)
...
rmarkdown::render(rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output","country_data_report_test_case.Rmd"),
                  ...
                  output_file="Country data report test case 6 updated"
)