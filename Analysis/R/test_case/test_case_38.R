...
## report
saveRDS(test_covariates_observation_final, "/home/app/cmp/Analysis/output/test_case_38_data_simulation_covariates.rdata")
...
config_filename <- "/home/app/cmp/Analysis/R/config_test_case_38.yml"
...
config <- list(general = list(
  ...
  criterion = ".choldir",
  "Analysis", "output", "test38.stan_input.rdata"
), stan_output = rprojroot::find_root_file(
  criterion = ".choldir",
  "Analysis", "output", "test38.stan_output.rds"
)), test_metadata = list(
  name = "test_38",
...
rmarkdown::render(
  ...
  output_file = "test_case_38_country_data_report"
)
