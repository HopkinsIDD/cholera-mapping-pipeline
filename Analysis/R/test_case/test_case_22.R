...
## report
saveRDS(test_covariates_observation_final, "/home/app/cmp/Analysis/output/test_case_22_data_simulation_covariates.rdata")
...
saveRDS(test_true_grid_cases, "/home/app/cmp/Analysis/output/test_case_22_true_grid_cases.rdata")
...
config_filename <- "/home/app/cmp/Analysis/R/config_test_case_22.yml"
...
config <- list(general = list(
  ...
  criterion = ".choldir",
  "Analysis", "output", "test22.stan_input.rdata"
), stan_output = rprojroot::find_root_file(
  criterion = ".choldir",
  "Analysis", "output", "test22.stan_output.rds"
)), test_metadata = list(
  name = "test_22",
  ...
  Loc_with_inconsistent_data = "-", Cov_data_simulation_filename = "/home/app/cmp/Analysis/output/test_case_22_data_simulation_covariates.rdata", test_true_grid_case_filename = "/home/app/cmp/Analysis/output/test_case_22_true_grid_cases.rdata"
))
...
rmarkdown::render(
  ...
  output_file = "test_case_22_country_data_report"
)
