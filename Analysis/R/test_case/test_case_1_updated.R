...
saveRDS(test_covariates_observation_final,"/home/app/cmp/Analysis/output/test_case_1_updated_data_simulation_covariates.rdata")
...
config_filename <- "/home/app/cmp/Analysis/R/test1_updated_config.yml"
...
config <- list(general = list(location_name = all_dfs$location_df$qualified_name[[1]], 
               ...
               file_names = list(stan_output = rprojroot::find_root_file(criterion = ".choldir","Analysis", "output", "test1_updated.stan_output.rdata"), 
                                 stan_input = rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output", "test1_updated.stan_input.rdata")),
               nrows=10,
               ncols=10,
               data_type="Grid data",
               oc_type="-",
               ...
               Cov_data_simulation_filename="/home/app/cmp/Analysis/output/test_case_1_updated_data_simulation_covariates.rdata"
)
