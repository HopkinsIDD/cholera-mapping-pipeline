...
## Note for kenya example: 2021-08-01 1. error shows invalid geometry data (while
## extracting for the whole 2000 year) 2. error shows after running 'Sampling
## Multinomial':Problem with 'summarise()' input 'covar' while running for one day
## data 2020-01-14
