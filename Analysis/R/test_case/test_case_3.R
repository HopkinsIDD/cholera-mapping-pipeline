...
config <- list(general = list(location_name = all_dfs$location_df$qualified_name[[1]],
    ...
    "Analysis", "output", "test3.stan_input.rdata"), stan_output = rprojroot::find_root_file(criterion = ".choldir",
    "Analysis", "output", "test3.stan_output.rdata")), test_metadata = list(name = "test_1",
