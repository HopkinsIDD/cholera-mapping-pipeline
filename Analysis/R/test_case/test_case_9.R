...
query_time_right <- c(lubridate::ymd("2000-05-30"), lubridate::ymd("2001-05-30"))
...
config <- list(general = list(
  ...
  Loc_with_inconsistent_data = "-", Cov_data_simulation_filename = "/home/app/cmp/Analysis/output/test_case_9_data_simulation_covariates.rdata"
))
...
output_file = "test_case_9_test_report"
)
