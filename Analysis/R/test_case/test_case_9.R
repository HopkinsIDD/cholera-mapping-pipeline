...
query_time_right <- lubridate::ymd("2000-02-19")
...
test_raster <- create_test_raster(nrows = 10, ncols = 10, nlayers = 7, test_extent = test_extent)
...
## report
# saveRDS(test_covariates_observation_final, "/home/app/cmp/Analysis/output/test_case_9_data_simulation_covariates.rdata")
...
test_observations <- observe_polygons(
  ...
  observation_time_left=lubridate::ymd("2000-01-03"),observation_time_right=lubridate::ymd("2000-01-10")
)
my_seed <- .GlobalEnv$.Random.seed
...
saveRDS(test_true_grid_cases,"/home/app/cmp/Analysis/output/test_case_9_true_grid_cases.rdata")
...
config_filename <- "/home/app/cmp/Analysis/R/config_test_case_9.yml"
...
config <- list(general = list(
  ...
  width_in_km = 1, height_in_km = 1, time_scale = "week", covariates = unique(sapply(
  ...
  Loc_with_inconsistent_data = "-", Cov_data_simulation_filename = "/home/app/cmp/Analysis/output/test_case_9_data_simulation_covariates.rdata",test_true_grid_case_filename="/home/app/cmp/Analysis/output/test_case_9_true_grid_cases.rdata"
...
#   ),
#   output_file = "test_case_9_country_data_report"
# )