...
covariates_table <- data.frame(
  nonspatial = c(FALSE, FALSE, TRUE,FALSE), nontemporal = c(
    FALSE,
    FALSE, FALSE,TRUE
  ), spatially_smooth = c(TRUE, TRUE, TRUE,FALSE), temporally_smooth = c(
    FALSE,
    FALSE, FALSE,TRUE
  ), polygonal = c(TRUE, TRUE, TRUE,TRUE), radiating = c(FALSE, FALSE, FALSE,FALSE),
  constant = c(TRUE, FALSE, FALSE,FALSE), Data_simulation_covariates = c(
    TRUE, TRUE,
    TRUE,TRUE
...
covariate3_raster_funs_observation[[2]]$name <- "covariate4"
covariate_raster_funs_observation[[4]] <- covariate3_raster_funs_observation[[2]]

## save additional covariates in the data generation process for country data
## report
saveRDS(test_covariates_observation_final, "/home/app/cmp/Analysis/output/test_case_28_data_simulation_covariates.rdata")
...
saveRDS(test_true_grid_cases,"/home/app/cmp/Analysis/output/test_case_28_true_grid_cases.rdata")
...
config_filename <- "/home/app/cmp/Analysis/R/config_test_case_28.yml"
...
config <- list(general = list(
  ...
  criterion = ".choldir",
  "Analysis", "output", "test28.stan_input.rdata"
), stan_output = rprojroot::find_root_file(
  criterion = ".choldir",
  "Analysis", "output", "test28.stan_output.rds"
)), test_metadata = list(
  name = "test_28",
  ...
  Loc_with_inconsistent_data = "-", Cov_data_simulation_filename = "/home/app/cmp/Analysis/output/test_case_28_data_simulation_covariates.rdata",test_true_grid_case_filename="/home/app/cmp/Analysis/output/test_case_28_true_grid_cases.rdata"
...
rmarkdown::render(
  ...
  output_file = "test_case_28_country_data_report"
)