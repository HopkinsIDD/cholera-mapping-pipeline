...
#test_covariates3_observation[[2]]$name<-'covariate3'
...
rmarkdown::render(rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output","country_data_report_test_case_single_year.Rmd"), 
