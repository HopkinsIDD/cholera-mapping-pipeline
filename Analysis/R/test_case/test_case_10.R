...
test_covariates_observation <- create_multiple_test_covariates(
  test_raster = test_raster_observation, ncovariates = 3,
...
config_filename <- "/home/app/cmp/Analysis/R/test10_2_config.yml"
...
config <- list(
  ...
  data_source = "sql",
  file_names = list(
    stan_output = rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output", "test10_2.stan_output.rdata"),
    stan_input = rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output", "test10_2.stan_input.rdata")
  ),
  nrows = 10,
  ncols = 10,
  data_type = "Grid data",
  oc_type = "Inconsistent observations over spatial levels (2 times difference)",
