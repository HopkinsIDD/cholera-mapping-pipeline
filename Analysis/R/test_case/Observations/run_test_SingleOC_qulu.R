...
all_dfs <- taxdat::create_testing_dfs_from_api(username = Sys.getenv("CHOLERA_API_USERNAME"), 
                                               api_key = Sys.getenv("CHOLERA_API_KEY"), locations = "AFR::KEN", time_left = lubridate::ymd("1997-01-01"), 
                                               time_right = lubridate::ymd("1971-12-31"), uids = NULL, website = "https://api.cholera-taxonomy.middle-distance.com/")
