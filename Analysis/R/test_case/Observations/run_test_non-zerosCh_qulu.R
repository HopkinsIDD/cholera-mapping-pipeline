...
nonZero_rowname=rownames(all_dfs$observations_df[which(all_dfs$observations_df$attributes.fields.suspected_cases>0&is.na(all_dfs$observations_df$attributes.fields.suspected_cases)==F),])
...
config_filename <- "/home/app/cmp/Analysis/R/test_config_nonZerosCh.yml"
...
#the error shows at :source(rprojroot::find_root_file(criterion = ".choldir", "Analysis", "R", "execute_pipeline.R"))