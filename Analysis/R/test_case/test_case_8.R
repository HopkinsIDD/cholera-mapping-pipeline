...
saveRDS(test_covariates_observation_final,"/home/app/cmp/Analysis/output/test_case_8_data_simulation_covariates.rdata")
...
saveRDS(test_true_grid_cases,"/home/app/cmp/Analysis/output/test_case_8_true_grid_cases.rdata")
...
all_dfs$observations_df=all_dfs$observations_df%>%subset(!qualified_name%in%c("1::2","1::10","1::20","1::86","1:94","1::89","1::56","1::9","1::99","1::80"))
...
config_filename <- "/home/app/cmp/Analysis/R/config_test_case_8.yml"
...
config <- list(general = list(location_name = all_dfs$location_df$qualified_name[[1]], 
               ...
               file_names = list(stan_output = rprojroot::find_root_file(criterion = ".choldir","Analysis", "output", "test8.stan_output.rdata"), 
                                 stan_input = rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output", "test8.stan_input.rdata")),
               nrows=10,
               ncols=10,
               data_type="Grid data",
               oc_type="-",
               ...
               Cov_data_simulation_filename="/home/app/cmp/Analysis/output/test_case_8_data_simulation_covariates.rdata",
               test_true_grid_case_filename="/home/app/cmp/Analysis/output/test_case_8_true_grid_cases.rdata"
)
...
rmarkdown::render(rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output","country_data_report_test_case.Rmd"),
                  params = list(config_filename = config_filename,
                                ...
                                test_true_grid_case_filename=config$test_true_grid_case_filename),
                  output_file="Country data report test case 8 updated"
)