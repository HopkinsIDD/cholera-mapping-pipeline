...
config_filename <- "/home/app/cmp/Analysis/R/test11_2_config.yml"
...
config <- list(
  ...
  data_source = "sql",
  file_names = list(
    stan_output = rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output", "test11_2.stan_output.rdata"),
    stan_input = rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output", "test11_2.stan_input.rdata")
  ),
  nrows = 10,
  ncols = 10,
  data_type = "Grid data",
