...
config <- list(general = list(
  ...
  Cov_data_simulation_filename = file.path(rprojroot::find_root(criterion = ".choldir"), "Analysis", "data", "test_case_2_true_grid_cases.rdata")
))
...
rmarkdown::render(
  ...
  output_file = "test_case_2_country_data_report"
)
