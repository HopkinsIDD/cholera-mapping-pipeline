...
config <- list(general = list(location_name = all_dfs$location_df$qualified_name[[1]],
    ...
    "Analysis", "output", "test2.stan_input.rdata"), stan_output = rprojroot::find_root_file(criterion = ".choldir",
    "Analysis", "output", "test2.stan_output.rdata")), test_metadata = list(name = "test_2",
    ...
    Loc_with_inconsistent_data = "-", Cov_data_simulation_filename = "/home/app/cmp/Analysis/output/test_case_2_data_simulation_covariates.rdata"))
...
rmarkdown::render(rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output",
    ...
    output_file = "Country data report test case 2 updated")
