...
saveRDS(test_covariates_observation,"/home/app/cmp/Analysis/output/test_case_1_5_data_simulation_covariates.rdata")
...
config_filename <- "/home/app/cmp/Analysis/R/test1_5_config.yml"
...
config <- list(general = list(location_name = all_dfs$location_df$qualified_name[[1]], 
               ...
               file_names = list(stan_output = rprojroot::find_root_file(criterion = ".choldir","Analysis", "output", "test1_5.stan_output.rdata"), 
                                 stan_input = rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output", "test1_5.stan_input.rdata")),
               nrows=10,
               ncols=10,
               data_type="Grid data",
               oc_type="-",
               ...
               Cov_data_simulation_filename="/home/app/cmp/Analysis/output/test_case_1_5_data_simulation_covariates.rdata"
)
...
rmarkdown::render(rprojroot::find_root_file(criterion = ".choldir", "Analysis", "output","country_data_report_test_case.Rmd"),
                  params = list(config_filename = config_filename,
                                ...
                                Cov_data_simulation_filename="/home/app/cmp/Analysis/output/test_case_1_5_data_simulation_covariates.rdata"),
                  output_file="Country data report test case 1 single year"
)