...
config_data_finder <- c("https://github.com/HopkinsIDD/cholera-configs/tree/master/Dec_2021_runs" = "Analysis/configs/Dec_2021_runs", #new model output config file dir
                        ...
                        "https://github.com/HopkinsIDD/cholera-mapping-output/tree/gavi_submission" = "Analysis/data/old_runs" ) #old model output data file dir
